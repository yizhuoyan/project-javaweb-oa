...
<body>
    ...
    <main>
    <form class="table" action="empmanage/mod.ajax" method="post">
    ...
    var loadModel = function(id) {
		return new Promise(function(ok,fail){
			var url = "empmanage/check.ajax?id=" + id;
	...
	var paintView = function(m) {
		...
		form.departmentId.value = $$("id",m.department);
        ...
        return false;
                ...
                var deleteConfirm = function() {
            		if (window.confirm("确认删除？")) {
            			var url = "empmanage/del.ajax?id=" + id;
            			$.getJSON(url,function(resp) {
            				if (resp.code === "ok") {
            					toast("删除成功！");
            					window.location.href = "empmanage/list.do";
