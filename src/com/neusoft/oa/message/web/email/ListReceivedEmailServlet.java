...
@WebServlet("/email/ListReceivedEmailServlet.do")
public class ListReceivedEmailServlet extends CommonServlet  {

	private static final long serialVersionUID = -1615086584445490626L;
	...
	protected String handleRequest(HttpServletRequest req, HttpServletResponse resp) throws Throwable {
		...
		try {
			...
			PaginationQueryResult<EmailEntity> result = fun.queryReceivedEmailByKey(uc.getName(), key,pageNo,pageSize);
		...
		return "/jsp/message/email/inbox/inbox.jsp";
	}
}
