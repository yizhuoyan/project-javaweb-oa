...
public class DocumentDaoImpl extends TemplateDaoImpl<DocumentEntity> implements DocumentDao {
	...
	public void insert(DocumentEntity t) throws Exception {
		...
		// 2创建sql语句对象
		String sql = DBUtil.generateInsertSql(this.tableName, "id,property,path,name,createUser_id,createTime,remark,flag,dept_id");
	...
	protected DocumentEntity resultset2entity(ResultSet rs) throws Exception {
		// TODO Auto-generated method stub  id,property,path,name,createUser_id,createTime,remark,flag,dept_id
